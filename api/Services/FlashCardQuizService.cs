...
{
    public class FlashCardQuizService(IQuizRepository<FlashCardQuiz> flashCardQuizRepository, IQuestionRepository<FlashCard> flashCardRepository, ILogger<FlashCardQuizService> logger) : IFlashCardQuizService
    {
        ...
        private readonly ILogger<FlashCardQuizService> _logger = logger;
