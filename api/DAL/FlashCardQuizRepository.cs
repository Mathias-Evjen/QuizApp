...
{
    public class FlashCardQuizRepository(QuizDbContext db, ILogger<FlashCardQuizRepository> logger) : IQuizRepository<FlashCardQuiz> 
    {
        private readonly QuizDbContext _db = db;
        private readonly ILogger<FlashCardQuizRepository> _logger = logger;
